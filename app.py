...
from blueprints.options_premium import options_premium_bp  # Import the options premium chart blueprint
...
def create_app():
    ...
    app.register_blueprint(options_premium_bp)  # Register options premium chart blueprint
